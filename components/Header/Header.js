    ...
    return (
        <header className="flex flex-col bg-blue-900 dark:bg-gray-400 text-white dark:text-black font-light">
            ...
            <div className="container mx-auto xs:hidden md:flex text-2xl py-4 flex flex-row justify-between items-center">
                ...
                <Image alt='some' src="/herb.svg.png" width={80} height={80} className="dark:grayscale"/>
            ...
            <div className="bg-white py-4">
                <div className="container mx-auto flex items-center justify-between text-black">
                    <div className="flex items-center text-2xl font-light gap-5">
                        <Image alt='some' src={props.logosrc} width={80} height={80} className="dark:grayscale"/>
